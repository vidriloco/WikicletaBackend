...
City.create(:country_code => "MX", :name => "Ciudad de México", :coordinates => "POINT(-99.133286 19.432676)")
City.create(:country_code => "MX", :name => "Guadalajara", :coordinates => "POINT(-103.3519 20.6661)")
City.create(:country_code => "MX", :name =>"Monterrey", :coordinates => "POINT(-100.3000 25.6667)")
City.create(:country_code => "MX", :name =>"Aguascalientes", :coordinates => "POINT(-102.2911 21.8842)")
City.create(:country_code => "MX", :name =>"Puebla", :coordinates => "POINT(-98.2092 19.0468)")
City.create(:country_code => "MX", :name =>"Juárez", :coordinates => "POINT(-106.48694 31.73944)")
City.create(:country_code => "MX", :name =>"Tijuana", :coordinates => "POINT(-117.0382 32.5149)")
City.create(:country_code => "MX", :name =>"León", :coordinates => "POINT(-101.6783 21.1327)")
City.create(:country_code => "MX", :name =>"Zapopan", :coordinates => "POINT(-103.4 20.7167)")
City.create(:country_code => "MX", :name =>"Chihuahua", :coordinates => "POINT(-106.0737 28.6306)")
City.create(:country_code => "MX", :name =>"Naucalpan", :coordinates => "POINT(-99.23367 19.47857)")
City.create(:country_code => "MX", :name =>"Acapulco", :coordinates => "POINT(-99.880097 16.863428)")
City.create(:country_code => "MX", :name =>"Chilpancingo", :coordinates => "POINT(-99.495575 17.545582)")
City.create(:country_code => "MX", :name =>"Cuernavaca", :coordinates => "POINT(-99.226410 18.922916)")
City.create(:country_code => "MX", :name =>"Toluca", :coordinates => "POINT(-99.643891 19.286258)")
City.create(:country_code => "MX", :name =>"Pachuca", :coordinates => "POINT(-98.748505 20.124029)")
City.create(:country_code => "MX", :name =>"Querétaro", :coordinates => "POINT(-100.385468 20.582396)")
City.create(:country_code => "MX", :name =>"Colima", :coordinates => "POINT(-103.736298 19.244773)")
City.create(:country_code => "MX", :name =>"Puerto Vallarta", :coordinates => "POINT(-105.219452 20.613248)")
City.create(:country_code => "MX", :name =>"Tepic", :coordinates => "POINT(-104.884369 21.505208)")
City.create(:country_code => "MX", :name =>"San Miguel de Allende", :coordinates => "POINT(-100.742523 20.921423)")
City.create(:country_code => "MX", :name =>"Poza Rica", :coordinates => "POINT(-97.463104 20.525818)")
City.create(:country_code => "MX", :name =>"Xalapa", :coordinates => "POINT(-96.913788 19.545296)")
City.create(:country_code => "MX", :name =>"Veracruz", :coordinates => "POINT(-96.133759 19.166962)")
City.create(:country_code => "MX", :name =>"Coatzacoalcos", :coordinates => "POINT(-94.425385 18.136456)")
City.create(:country_code => "MX", :name =>"Tuxtla Gutiérrez", :coordinates => "POINT(-93.107025 16.747740)")
City.create(:country_code => "MX", :name =>"Oaxaca", :coordinates => "POINT(-96.716034 17.057835)")
City.create(:country_code => "MX", :name =>"Puerto Escondido", :coordinates => "POINT(-97.073090 15.877866)")
City.create(:country_code => "MX", :name =>"Villahermosa", :coordinates => "POINT(-92.925751 17.995452)")
City.create(:country_code => "MX", :name =>"Mérida", :coordinates => "POINT(-89.607880 20.977854)")
City.create(:country_code => "MX", :name =>"Campeche", :coordinates => "POINT(-90.509811 19.834410)")
City.create(:country_code => "MX", :name =>"Cancún", :coordinates => "POINT(-86.834885 21.164435)")
City.create(:country_code => "MX", :name =>"Playa del Carmen", :coordinates => "POINT(-87.073837 20.638439)")
City.create(:country_code => "MX", :name =>"San Luis Potosi", :coordinates => "POINT(-100.971131 22.148743)")
City.create(:country_code => "MX", :name =>"Tampico", :coordinates => "POINT(-97.840027 22.280964)")
City.create(:country_code => "MX", :name =>"Ciudad Victoria", :coordinates => "POINT(-99.125428 23.747137)")
City.create(:country_code => "MX", :name =>"Saltillo", :coordinates => "POINT(-101.004090 25.415493)")
City.create(:country_code => "MX", :name =>"Torreón", :coordinates => "POINT(-103.410096 25.554336)")
City.create(:country_code => "MX", :name =>"Durango", :coordinates => "POINT(-104.651551 24.018369)")
City.create(:country_code => "MX", :name =>"Mazatlán", :coordinates => "POINT(-106.398377 23.223174)")
City.create(:country_code => "MX", :name =>"Los Mochis", :coordinates => "POINT(-108.969178 25.791978)")
City.create(:country_code => "MX", :name =>"Hermosillo", :coordinates => "POINT(-110.957703 29.086897)")
City.create(:country_code => "MX", :name =>"Mexicalli", :coordinates => "POINT(-115.440125 32.622720)")
City.create(:country_code => "MX", :name =>"Ensenada", :coordinates => "POINT(-116.593689 31.851431)")
City.create(:country_code => "MX", :name =>"La Paz", :coordinates => "POINT(-110.298523 24.118681)")
City.create(:country_code => "MX", :name =>"Cabo San Lucas", :coordinates => "POINT(-109.903015 22.879465)")
City.create(:country_code => "MX", :name =>"Monclova", :coordinates => "POINT(-101.395386 26.906396)")
City.create(:country_code => "MX", :name =>"Matamoros", :coordinates => "POINT(-97.484254 25.823628)")
City.create(:country_code => "MX", :name =>"Nuevo Laredo", :coordinates => "POINT(-99.527711 27.473187)")
City.create(:country_code => "MX", :name =>"Tehuacán", :coordinates => "POINT(-97.396363 18.442093)")
City.create(:country_code => "MX", :name =>"Morelia", :coordinates => "POINT(-101.175660 19.667419)")
