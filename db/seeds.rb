...
AdminUser.create([
{:email => "c.alexisrivas.c@hotmail.com", :encrypted_password => "$2a$10$kclogsEQ.PDm5cnhOzRd7ewNqTDi1zWhFGf59OD4NJDJAwccOTS/O", :reset_password_token => nil, :reset_password_sent_at => nil, :remember_created_at => nil, :sign_in_count => 16, :current_sign_in_at => "2013-06-20 23:09:54", :last_sign_in_at => "2013-06-18 20:09:50", :current_sign_in_ip => "189.242.109.167", :last_sign_in_ip => "189.242.109.167", :created_at => "2013-05-17 11:56:40", :updated_at => "2013-06-20 23:09:54"},
{:email => "admin@example.com", :encrypted_password => "$2a$10$qkXEvLyl4WvpTUfsOVk2bOn7JZ6eMBmSw2/hYjb8EL0Rp5T1TuDJe", :reset_password_token => nil, :reset_password_sent_at => nil, :remember_created_at => nil, :sign_in_count => 12, :current_sign_in_at => "2013-08-23 08:18:01", :last_sign_in_at => "2013-08-22 03:04:58", :current_sign_in_ip => "187.233.126.115", :last_sign_in_ip => "187.233.89.117", :created_at => "2013-05-16 19:44:19", :updated_at => "2013-08-23 08:18:01"},
{:email => "vidriloco@gmail.com", :encrypted_password => "$2a$10$lkmyAwsfKZ4vshN4pIFKxe8xJQYin/mUc6rKE19iI74yU52CermGK", :reset_password_token => nil, :reset_password_sent_at => nil, :remember_created_at => nil, :sign_in_count => 2, :current_sign_in_at => "2013-09-11 17:27:07", :last_sign_in_at => "2013-05-31 02:03:36", :current_sign_in_ip => "187.234.40.231", :last_sign_in_ip => "212.78.197.234", :created_at => "2013-05-31 02:03:25", :updated_at => "2013-09-11 17:27:07"}]) 

City.create([
{:name => "Ciudad de México", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.133286 19.432676)"},
{:name => "Guadalajara", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-103.3519 20.6661)"},
{:name => "Monterrey", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-100.3 25.6667)"},
{:name => "Aguascalientes", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-102.2911 21.8842)"},
{:name => "Puebla", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-98.2092 19.0468)"},
{:name => "Juárez", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-106.48694 31.73944)"},
{:name => "Tijuana", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-117.0382 32.5149)"},
{:name => "León", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-101.6783 21.1327)"},
{:name => "Zapopan", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-103.4 20.7167)"},
{:name => "Chihuahua", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-106.0737 28.6306)"},
{:name => "Naucalpan", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.23367 19.47857)"},
{:name => "Acapulco", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.880097 16.863428)"},
{:name => "Chilpancingo", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.495575 17.545582)"},
{:name => "Cuernavaca", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.22641 18.922916)"},
{:name => "Toluca", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.643891 19.286258)"},
{:name => "Pachuca", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-98.748505 20.124029)"},
{:name => "Querétaro", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-100.385468 20.582396)"},
{:name => "Colima", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-103.736298 19.244773)"},
{:name => "Puerto Vallarta", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-105.219452 20.613248)"},
{:name => "Tepic", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-104.884369 21.505208)"},
{:name => "San Miguel de Allende", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-100.742523 20.921423)"},
{:name => "Poza Rica", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-97.463104 20.525818)"},
{:name => "Xalapa", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-96.913788 19.545296)"},
{:name => "Veracruz", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-96.133759 19.166962)"},
{:name => "Coatzacoalcos", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-94.425385 18.136456)"},
{:name => "Tuxtla Gutiérrez", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-93.107025 16.74774)"},
{:name => "Oaxaca", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-96.716034 17.057835)"},
{:name => "Puerto Escondido", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-97.07309 15.877866)"},
{:name => "Villahermosa", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-92.925751 17.995452)"},
{:name => "Mérida", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-89.60788 20.977854)"},
{:name => "Campeche", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-90.509811 19.83441)"},
{:name => "Cancún", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-86.834885 21.164435)"},
{:name => "Playa del Carmen", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-87.073837 20.638439)"},
{:name => "San Luis Potosi", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-100.971131 22.148743)"},
{:name => "Tampico", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-97.840027 22.280964)"},
{:name => "Ciudad Victoria", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.125428 23.747137)"},
{:name => "Saltillo", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-101.00409 25.415493)"},
{:name => "Torreón", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-103.410096 25.554336)"},
{:name => "Durango", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-104.651551 24.018369)"},
{:name => "Mazatlán", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-106.398377 23.223174)"},
{:name => "Los Mochis", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-108.969178 25.791978)"},
{:name => "Hermosillo", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-110.957703 29.086897)"},
{:name => "Mexicalli", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-115.440125 32.62272)"},
{:name => "Ensenada", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-116.593689 31.851431)"},
{:name => "La Paz", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-110.298523 24.118681)"},
{:name => "Cabo San Lucas", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-109.903015 22.879465)"},
{:name => "Monclova", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-101.395386 26.906396)"},
{:name => "Matamoros", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-97.484254 25.823628)"},
{:name => "Nuevo Laredo", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-99.527711 27.473187)"},
{:name => "Tehuacán", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-97.396363 18.442093)"},
{:name => "Morelia", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-101.17566 19.667419)"},
{:name => "Celaya", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-100.808441 20.525818)"},
{:name => "Tlaxcala", :country_code => "MX", :created_at => "2013-09-18 08:12:04", :updated_at => "2013-09-18 08:12:04", :alt_id => nil, :coordinates => "POINT (-98.232147 19.322548)"},
{:name => "Chetumal", :country_code => "MX", :created_at => "2013-09-21 06:52:19", :updated_at => "2013-09-21 06:52:19", :alt_id => nil, :coordinates => "POINT (-88.300552 18.516682)"},
{:name => "Irapuato", :country_code => "MX", :created_at => "2013-09-21 06:52:25", :updated_at => "2013-09-21 06:52:25", :alt_id => nil, :coordinates => "POINT (-101.353683 20.680929)"}]) 

CyclingGroup.create([
{:name => "Chihuahua en Bicicleta", :details => "\"Recuperando nuestra ciudad una bicicleta a la vez\".

Chihuahua en Bicicleta empezó en Agosto del 2010. Es un grupo de Ciudadanos en Bicicleta, sin afiliaciones políticas, que buscan promover su uso como medio de transporte.", :meeting_time => "17:00", :departing_time => "18:30", :periodicity => "0|2|1", :twitter_account => "chihenbici", :facebook_url => "https://www.facebook.com/groups/ChihuahuaEnBicicleta", :website_url => "http://chihenbici.org/", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 22:39:54", :coordinates => "POINT (-106.09916031360626 28.641367524173308)"},
{:name => "Juárez en Bicla", :details => "Grupo ciudadano apartidista sin fines de lucro, creado para fomentar el ciclismo urbano, de forma segura y respetando el tráfico. Paseos el 1ro. y 3er. Domingo de cada mes a las 6:30 en Plaza Juárez Mall a un lado de las canchas de Futbol.", :meeting_time => "18:30", :departing_time => "19:00", :periodicity => "0|1|1", :twitter_account => "", :facebook_url => "https://www.facebook.com/groups/juarezenbicla", :website_url => "https://www.facebook.com/JuarezEnBicla", :updated_at => "2013-09-20 06:43:08", :created_at => "2013-09-19 18:53:12", :coordinates => "POINT (-106.42659902572632 31.706245246490237)"},
{:name => "Bikes & Beers Crew", :details => "Cada miérc nos acompañan mil baikas a un recorrido en Hermosillo que cambia cada semana y terminamos en un lugar distinto cada ocasión. El mismo día publicamos todo bnbcrew.com Recomendaciones: http://bnbcrew.com/cultura-vial/seguridad-en-las-rodada", :meeting_time => "20:30", :departing_time => "20:30", :periodicity => "3|2|", :twitter_account => "bikesnbeerscrew", :facebook_url => "www.facebook.com/bnbrilas", :website_url => "www.bnbcrew.com", :updated_at => "2013-09-18 09:43:36", :created_at => "2013-09-18 09:34:35", :coordinates => "POINT (-110.95820724964142 29.08292322755854)"},
{:name => "Roadster VD", :details => "Grupo de ciclismo, con diferentes categorías, Infantil, femenil, mixto, urbano y de montaña, 
Uno de los mejores grupos al norte de la Cd. de Mexico Rodamos 
Miércoles,Sábados y Domingos
Nuestro cuartel general esta en Aragon en la GAM ", :meeting_time => "19:00", :departing_time => "19:30", :periodicity => "3|2|1", :twitter_account => "", :facebook_url => "https://www.facebook.com/Roadstervd?ref=hl", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:30:28", :coordinates => "POINT (-99.06630635261536 19.450821350092408)"},
{:name => "Ciclismo Urbano De Saltillo", :details => "Los recorridos del grupo son completamente recreativos, hacemos recorridos mayores de 10km y que no pasan de 40km  según como lo pida el grupo. Acompáñanos lunes y martes Plaza Morelos  (González Lobo y Nava Col República)  Te esperamos!", :meeting_time => "19:30", :departing_time => "20:00", :periodicity => "2|2|", :twitter_account => "", :facebook_url => "https://www.facebook.com/love.saltillo", :website_url => "", :updated_at => "2013-09-20 06:37:33", :created_at => "2013-09-19 22:00:49", :coordinates => "POINT (-100.9883987903595 25.43752933846048)"},
{:name => "Bikennedy", :details => "hemos pensado en crear un grupo dentro de nuestra localidad, la localidad 8va Kennedy, que promueva el uso de la bicicleta para transportarse de manera sana, saludable, ágil y segura.", :meeting_time => "19:00", :departing_time => "19:30", :periodicity => "4|2|1", :twitter_account => "bikennedy", :facebook_url => "https://www.facebook.com/francisco.cifuentes.79219", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:54:33", :coordinates => "POINT (-74.14782285690308 4.631302319184896)"},
{:name => "La Gran Rodada", :details => "Los biciusuarios de Colombia nos unimos para ganarnos más seguridad, respeto y protección. ¡A pedalear! ", :meeting_time => "14:30", :departing_time => "15:30", :periodicity => "6|1|1", :twitter_account => "LaGranRodada", :facebook_url => "https://www.facebook.com/lagranrodada01", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 19:22:35", :coordinates => "POINT (-74.06541466712952 4.624367352339642)"},
{:name => "Enbiciate Xalapa", :details => "Enbiciate Xalapa es una  campaña comunicacional para la concientización de la ciudadanía en general, principalmente a los conductores de vehículos automotores, sobre el uso de la bicicleta como herramienta de movilidad cotidiana en la ciudad.", :meeting_time => "8:30", :departing_time => "9:00", :periodicity => "2|1|-1", :twitter_account => "EnbiciateXalapa", :facebook_url => "https://www.facebook.com/EnbiciateXalapa", :website_url => "https://www.facebook.com/EnbiciateXalapa", :updated_at => "2013-09-20 06:37:58", :created_at => "2013-09-19 21:44:38", :coordinates => "POINT (-96.91711664199829 19.529761523795795)"},
{:name => "Nueva Alianza ciclista de la zona metropolitana Xalapa", :details => "Buscamos promover la bicicleta como medio de transporte válido en la ciudad de Xalapa, Veracruz en el marco del Día Mundial sin Auto, el 22 de Septiembre de 2013, pintando líneas de vida. Punto de reunión Parque Juárez. 120 BICICLETAS EN PRÉSTAMO!!! ", :meeting_time => "10:00", :departing_time => "10:30", :periodicity => "0|3|", :twitter_account => "", :facebook_url => "https://www.facebook.com/events/527272103994609/?ref=2", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 22:05:52", :coordinates => "POINT (-96.92376852035522 19.527061708208706)"},
{:name => "Mujeres al Pedal", :details => "Un grupo dedicado a la mujer ciclista inicial, aunque el hombre es bienvenido.", :meeting_time => "8:00", :departing_time => "8:00", :periodicity => "2|2|1", :twitter_account => "", :facebook_url => "http://www.facebook.com/groups/269086769884655/", :website_url => "http://mujeresalpedal.blogspot.mx/", :updated_at => "2013-09-19 23:07:43", :created_at => "2013-09-19 23:07:43", :coordinates => "POINT (-115.45429229736328 32.63863855400811)"},
{:name => "Physis Ciclovida Xalapa", :details => "MIÉRCOLES CICLOVIDA NOCTURNA EN XALAPA 20:30hrs. Cueva de la orquídea, Xalapa, Ver. México
>>>http://youtu.be/tTPefZP7UME Lo importante es que la gente se convenza de que es posible moverse en bicicleta. \"Se trata de perderle el miedo a las calles\"", :meeting_time => "20:30", :departing_time => "21:00", :periodicity => "3|2|", :twitter_account => "PhysisCiclovida", :facebook_url => "https://www.facebook.com/physis.alimentandoconnaturaleza", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 23:26:20", :coordinates => "POINT (-96.91635489463806 19.545797700338753)"},
{:name => "Acapulco Vélo", :details => "Paseo de tod@s, el ultimo jueves de cada mes, nos damos cita en la Diana Cazadora, sobre av. costera En Acapulco Gro.", :meeting_time => "19:45", :departing_time => "20:00", :periodicity => "4|1|-1", :twitter_account => "AcapulcoVelo", :facebook_url => "https://www.facebook.com/pages/Acapulco-V%C3%A9lo-AC/524092137649532?fref=ts", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:32:39", :coordinates => "POINT (-99.87231016159058 16.859214279105636)"},
{:name => "Roadster VD Femenil ", :details => "Grupo de ciclismo, especial para mujeres que quieren rodar, los sábados muy temprano, ", :meeting_time => "8:45", :departing_time => "9:00", :periodicity => "6|2|1", :twitter_account => "", :facebook_url => "", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:55:05", :coordinates => "POINT (-99.06625270843506 19.450730301420336)"},
{:name => "Cuadrante Rosita", :details => "Grupo que gusta de rodar sin importar las circunstancias.
Domingo a Jueves", :meeting_time => "19:45", :departing_time => "20:00", :periodicity => "1|2|", :twitter_account => "", :facebook_url => "https://www.facebook.com/groups/Rositasaferrados/", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:57:09", :coordinates => "POINT (-115.45480728149414 32.66331325103566)"},
{:name => "Roadster VD Infantil ", :details => "La llamamos Rodadita, es una rodada de 2 km, exclusiva para niños, de 3 a 7 años... 
Simplemente la pasan genial.. este mes aumentaremos la ruda a 3 Km.", :meeting_time => "11:30", :departing_time => "12:00", :periodicity => "6|2|1", :twitter_account => "", :facebook_url => "https://www.facebook.com/Roadstervd?ref=hl", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:59:09", :coordinates => "POINT (-99.06637072563171 19.4508415831237)"},
{:name => "Oaxacletos", :details => "Grupo de amigos ciclistas de bicicleta de montaña de la Ciudad de Oaxaca.

Se crea con la intención de conocer nuevas rutas, programar salidas, confirmar asistencia, hacer recomendaciones sobre peligros o precauciones a tomar en algún recorrido...", :meeting_time => "7:45", :departing_time => "8:00", :periodicity => "0||", :twitter_account => "", :facebook_url => "https://www.facebook.com/groups/152122101521360/", :website_url => "", :updated_at => "2013-09-20 06:36:36", :created_at => "2013-09-19 19:56:02", :coordinates => "POINT (-96.71899795532227 17.0691130244348)"},
{:name => "Nitos Ciclistas en Movimiento", :details => "Somos un grupo de personas que se reunen con el único propósito de disfrutar Oaxaca y sus alrededores a través de la bicicleta y con ello promocionar el uso de la bicicleta como medio de transporte cotidiano.", :meeting_time => "7:30", :departing_time => "8:00", :periodicity => "0|2|", :twitter_account => "", :facebook_url => "https://www.facebook.com/groups/Nitos.ciclistasenmovimiento/", :website_url => "https://www.facebook.com/NitosCiclistasEnMovimiento?ref=hl", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 22:48:51", :coordinates => "POINT (-96.72396272420883 17.05968473242502)"},
{:name => "Ellas Ruedan Xalapa", :details => "Ellas Ruedan Xalapa es un colectivo coordinado por mujeres y con una visión incluyente, por lo que si eres mujer u hombre siempre serás bienvenido a rodar. La cita es en la plaza gastronómica de San José en Xalapa, Veracruz. TODOS LOS MARTES 8:30 PM.", :meeting_time => "8:30", :departing_time => "9:00", :periodicity => "2|2|", :twitter_account => "EllasRuedanXal", :facebook_url => "https://www.facebook.com/ellasruedan.xalapa", :website_url => "https://www.facebook.com/ellasruedan.xalapa", :updated_at => "2013-09-20 06:35:04", :created_at => "2013-09-19 21:32:42", :coordinates => "POINT (-96.91692352294922 19.529640184737794)"},
{:name => "Ellas Ruedan Xalapa MTB y Exiliados MTB", :details => "No todo son paseos urbanos, si eres de los que les gusta salir a la montaña, acompáñanos todos los sábados a las 8 am en la entrada de la USBI XALAPA y junto con los EXILIADOS MTB aprende rutas, técnicas, haz amigos en la montaña y diviértete. ", :meeting_time => "8:00", :departing_time => "8:30", :periodicity => "6|2|", :twitter_account => "EllasRuedanXal", :facebook_url => "https://www.facebook.com/ellasruedan.xalapa", :website_url => "https://www.facebook.com/ellasruedan.xalapa", :updated_at => "2013-09-20 06:33:40", :created_at => "2013-09-19 23:34:44", :coordinates => "POINT (-96.91754579544067 19.514552985172365)"},
{:name => "Delicias en Bicicleta", :details => "- La idea principal de este grupo es crear un colectivo civil el cual organiza bicicletadas frecuentemente e impulse el uso de la bicicleta en la ciudad.", :meeting_time => "18:00", :departing_time => "18:30", :periodicity => "0|2|1", :twitter_account => "DeliciasenBici", :facebook_url => "https://www.facebook.com/DeliciasEnBicicleta", :website_url => "https://www.facebook.com/DeliciasEnBicicleta", :updated_at => "2013-09-20 06:34:32", :created_at => "2013-09-20 05:44:49", :coordinates => "POINT (-105.47884315252304 28.191002511050197)"},
{:name => "Ciclonautas", :details => "Recorridos urbanos montaña los viernes  9:30 p.m. Cerro de las Campanas. Obligatorio Casco y luz delantera. Nivel Intermedio
Sin costo. Querétaro.  Dinero para tacos al final del recorrido.
Buena aptitud. Llevar herramienta básica.", :meeting_time => "21:00", :departing_time => "21:30", :periodicity => "5|2|-1", :twitter_account => "ciclonautasmx", :facebook_url => "https://www.facebook.com/ciclonautas", :website_url => "https://www.facebook.com/CiclonautasMx?ref=hl", :updated_at => "2013-09-20 15:10:03", :created_at => "2013-09-20 15:10:03", :coordinates => "POINT (-100.40831744670868 20.593299226119903)"},
{:name => "cuadranterosita", :details => "cuadranterosita", :meeting_time => "7:45", :departing_time => "8:00", :periodicity => "4|2|", :twitter_account => "", :facebook_url => "", :website_url => "", :updated_at => "2013-09-20 16:28:46", :created_at => "2013-09-20 16:28:46", :coordinates => "POINT (-115.45489311218262 32.663222929583306)"},
{:name => "Por el Gusto de Rodar", :details => "Somos un colectivo de ciclistas urbanos que compartimos gustos y aficiones. La principal: el uso de la bici como medio de transporte. Grupo creado entre amigos que nos conocimos rodando y rodando queremos hacer más amigos. ¿te unes?", :meeting_time => "21:00", :departing_time => "21:30", :periodicity => "3|2|", :twitter_account => "elgustoderodar", :facebook_url => "https://www.facebook.com/groups/porelgustoderodar/?fref=ts", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 23:31:37", :coordinates => "POINT (-99.16375637054443 19.349240025320093)"},
{:name => "Mountain Teotihuacan Bike", :details => "Grupo de aficionados al ciclismo de Montaña, ubicados en el valle de Teotihuacan ( San Martin de las Pirámides) rodadas todos los domingos para todos los niveles", :meeting_time => "8:45", :departing_time => "9:15", :periodicity => "0|2|", :twitter_account => "", :facebook_url => "https://www.facebook.com/MountainTeotihuacanBike", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 23:47:45", :coordinates => "POINT (-98.83506774902344 19.704798987547214)"},
{:name => "Amigos del Pedal Xalapa MTB", :details => "Porque la banda lo pidió, nos vamos a Carrizal!", :meeting_time => "7:30", :departing_time => "8:00", :periodicity => "0|2|1", :twitter_account => "", :facebook_url => "https://www.facebook.com/AmigosDelPedalXalapa", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 23:58:10", :coordinates => "POINT (-96.91767454147339 19.514674335559274)"},
{:name => "BiciArdillas Aragón", :details => "Ciclistas fomentando el uso de la bici en San Juan de Aragón.", :meeting_time => "5:00", :departing_time => "5:15", :periodicity => "0|2|1", :twitter_account => "biciardillas", :facebook_url => "https://www.facebook.com/groups/BiciardillasAragon/", :website_url => "http://www.biciardillas.com", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-20 04:32:25", :coordinates => "POINT (-99.0664404630661 19.46516593584972)"},
{:name => "Bici Activate Matamoros", :details => "Promover el uso de la bicicleta como un medio de transporte sustentable y una sociedad matamorense más ecológica...unos somos todos y todos somos uno.
nuestro paseo ciclista es al ritmo del mas lento asi que todos vamos en grupo disfrutando del paseo", :meeting_time => "17:45", :departing_time => "18:15", :periodicity => "6|2|1", :twitter_account => "joelfraga", :facebook_url => "https://www.facebook.com/BiciActivateMatamoros", :website_url => "", :updated_at => "2013-09-20 06:32:29", :created_at => "2013-09-19 17:07:47", :coordinates => "POINT (-97.50100135803223 25.884786013414217)"},
{:name => "MXLIBICI", :details => "Grupo organizado de la sociedad que promueve el ciclismo urbano como alternativa de transporte y que gestiona políticas de movilidad incluyente en la ciudad de Mexicali, Baja California.", :meeting_time => "19:30", :departing_time => "19:45", :periodicity => "5|2|", :twitter_account => "MXLIBICI", :facebook_url => "http://www.facebook.com/MXLIBICI", :website_url => "http://www.mxlibici.org", :updated_at => "2013-09-20 17:14:13", :created_at => "2013-09-20 17:14:13", :coordinates => "POINT (-115.44843435287476 32.64127211090212)"},
{:name => "IRAPUATO EN BICI", :details => "MIERCOLES CHICAS IRAPUATO EN BICI", :meeting_time => "19:30", :departing_time => "19:45", :periodicity => "3|2|1", :twitter_account => "IrapuatoenBici", :facebook_url => "https://www.facebook.com/irapuatoenbici.grupodeciclismo?ref=tn_tnmn", :website_url => "https://www.facebook.com/irapuatoenbici.grupodeciclismo?ref=tn_tnmn", :updated_at => "2013-09-20 17:49:37", :created_at => "2013-09-20 17:42:05", :coordinates => "POINT (-99.20628547668457 19.38572876538974)"},
{:name => "Bici 10", :details => "Bici 10 es un paseo nocturno con el fin de promover el uso de la bicicleta en lugar del auto.
Reunidos en el Andador Escorza se parte hacia diferentes puntos de la ciudad, con una duracion aproximada de dos horas; finalizando en el punto de partida.", :meeting_time => "10:00", :departing_time => "10:00", :periodicity => "3|2|", :twitter_account => "", :facebook_url => "https://www.facebook.com/groups/178009569842/", :website_url => "http://www.bici10.org", :updated_at => "2013-09-20 21:09:40", :created_at => "2013-09-20 21:09:40", :coordinates => "POINT (-103.35855960845947 20.674515069020366)"},
{:name => "Quiron", :details => "prueba", :meeting_time => "8:15", :departing_time => "9:15", :periodicity => "||", :twitter_account => "", :facebook_url => "", :website_url => "", :updated_at => "2013-09-21 22:16:45", :created_at => "2013-09-21 22:16:45", :coordinates => "POINT (-116.58382415771484 31.88961941785702)"},
{:name => "Guanajuato en Bici", :details => "Nuestro objetivo es invitar a la Comunidad Universitaria a practicar el ciclismo recreativo como una alternativa para el autocuidado de su salud.", :meeting_time => "17:30", :departing_time => "18:00", :periodicity => "1|2|1", :twitter_account => "", :facebook_url => "https://www.facebook.com/GuanajuatoEnBici", :website_url => "", :updated_at => "2013-09-23 15:03:10", :created_at => "2013-09-23 15:03:10", :coordinates => "POINT (-101.25101923942566 21.012907429641537)"},
{:name => "Comando B", :details => "Grupo aficionado a la bicicleta y cervezas.
Punto de Reunión: Jardin Emabajdoras", :meeting_time => "7:00", :departing_time => "7:30", :periodicity => "0|2|", :twitter_account => "", :facebook_url => "", :website_url => "", :updated_at => "2013-09-23 15:52:10", :created_at => "2013-09-23 15:52:10", :coordinates => "POINT (-101.24914169311523 21.011485241041832)"}]) 

CyclingGroupAdmin.create([
{:permissions => nil, :verified => nil, :updated_at => "2013-09-18 09:34:38", :created_at => "2013-09-18 09:34:38", :cycling_group_id => CyclingGroup.where(:slug => 'bikes-beers-crew').first.id, :user_id => User.where(:username => 'claribon').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:07:51", :created_at => "2013-09-19 17:07:51", :cycling_group_id => CyclingGroup.where(:slug => 'bici-activate-matamoros').first.id, :user_id => User.where(:username => 'Joelfraga').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:30:36", :created_at => "2013-09-19 17:30:36", :cycling_group_id => CyclingGroup.where(:slug => 'roadster-vd').first.id, :user_id => User.where(:username => 'openmexico050974').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:32:41", :created_at => "2013-09-19 17:32:41", :cycling_group_id => CyclingGroup.where(:slug => 'acapulco-velo').first.id, :user_id => User.where(:username => 'anita').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:54:38", :created_at => "2013-09-19 17:54:38", :cycling_group_id => CyclingGroup.where(:slug => 'bikennedy').first.id, :user_id => User.where(:username => 'BIKENNEDY').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:55:17", :created_at => "2013-09-19 17:55:17", :cycling_group_id => CyclingGroup.where(:slug => 'roadster-vd-femenil').first.id, :user_id => User.where(:username => 'openmexico050974').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:57:14", :created_at => "2013-09-19 17:57:14", :cycling_group_id => CyclingGroup.where(:slug => 'cuadrante-rosita').first.id, :user_id => User.where(:username => 'fher79rm').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 17:59:35", :created_at => "2013-09-19 17:59:35", :cycling_group_id => CyclingGroup.where(:slug => 'roadster-vd-infantil').first.id, :user_id => User.where(:username => 'openmexico050974').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 18:53:15", :created_at => "2013-09-19 18:53:15", :cycling_group_id => CyclingGroup.where(:slug => 'juarez-en-bicla').first.id, :user_id => User.where(:username => 'iortegaa').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 19:22:40", :created_at => "2013-09-19 19:22:40", :cycling_group_id => CyclingGroup.where(:slug => 'la-gran-rodada').first.id, :user_id => User.where(:username => 'lagranrodada').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 19:56:06", :created_at => "2013-09-19 19:56:06", :cycling_group_id => CyclingGroup.where(:slug => 'oaxacletos').first.id, :user_id => User.where(:username => 'Ramirojr').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 21:35:27", :created_at => "2013-09-19 21:35:27", :cycling_group_id => CyclingGroup.where(:slug => 'ellas-ruedan-xalapa').first.id, :user_id => User.where(:username => 'EllasRuedanXalapa').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 21:44:44", :created_at => "2013-09-19 21:44:44", :cycling_group_id => CyclingGroup.where(:slug => 'enbiciate-xalapa').first.id, :user_id => User.where(:username => 'EllasRuedanXalapa').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 22:00:55", :created_at => "2013-09-19 22:00:55", :cycling_group_id => CyclingGroup.where(:slug => 'ciclismo-urbano-de-saltillo').first.id, :user_id => User.where(:username => 'rrodovaldez').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 22:05:56", :created_at => "2013-09-19 22:05:56", :cycling_group_id => CyclingGroup.where(:slug => 'nueva-alianza-ciclista-de-la-zona-metropolitana-xalapa').first.id, :user_id => User.where(:username => 'EllasRuedanXalapa').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 22:39:57", :created_at => "2013-09-19 22:39:57", :cycling_group_id => CyclingGroup.where(:slug => 'chihuahua-en-bicicleta').first.id, :user_id => User.where(:username => 'chihenbici').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 22:49:03", :created_at => "2013-09-19 22:49:03", :cycling_group_id => CyclingGroup.where(:slug => 'nitos-ciclistas-en-movimiento').first.id, :user_id => User.where(:username => 'RickBerech').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 23:07:50", :created_at => "2013-09-19 23:07:50", :cycling_group_id => CyclingGroup.where(:slug => 'mujeres-al-pedal').first.id, :user_id => User.where(:username => 'Kamelie').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 23:26:23", :created_at => "2013-09-19 23:26:23", :cycling_group_id => CyclingGroup.where(:slug => 'physis-ciclovida-xalapa').first.id, :user_id => User.where(:username => 'PhysisCiclovidaXalapa').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 23:31:38", :created_at => "2013-09-19 23:31:38", :cycling_group_id => CyclingGroup.where(:slug => 'por-el-gusto-de-rodar').first.id, :user_id => User.where(:username => 'andreadijo').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 23:34:50", :created_at => "2013-09-19 23:34:50", :cycling_group_id => CyclingGroup.where(:slug => 'ellas-ruedan-xalapa-mtb-y-exiliados-mtb').first.id, :user_id => User.where(:username => 'EllasRuedanXalapa').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 23:47:46", :created_at => "2013-09-19 23:47:46", :cycling_group_id => CyclingGroup.where(:slug => 'mountain-teotihuacan-bike').first.id, :user_id => User.where(:username => 'mtbteotihuacan1').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-19 23:58:10", :created_at => "2013-09-19 23:58:10", :cycling_group_id => CyclingGroup.where(:slug => 'amigos-del-pedal-xalapa-mtb').first.id, :user_id => User.where(:username => 'vazbaumax').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 04:32:30", :created_at => "2013-09-20 04:32:30", :cycling_group_id => CyclingGroup.where(:slug => 'biciardillas-aragon').first.id, :user_id => User.where(:username => 'zapika').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 05:44:53", :created_at => "2013-09-20 05:44:53", :cycling_group_id => CyclingGroup.where(:slug => 'delicias-en-bicicleta').first.id, :user_id => User.where(:username => 'LFREDEKOP').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 15:10:07", :created_at => "2013-09-20 15:10:07", :cycling_group_id => CyclingGroup.where(:slug => 'ciclonautas').first.id, :user_id => User.where(:username => 'ciclonautas').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 16:28:47", :created_at => "2013-09-20 16:28:47", :cycling_group_id => CyclingGroup.where(:slug => 'cuadranterosita').first.id, :user_id => User.where(:username => 'cuadranterosita').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 17:14:18", :created_at => "2013-09-20 17:14:18", :cycling_group_id => CyclingGroup.where(:slug => 'mxlibici').first.id, :user_id => User.where(:username => 'Caro_mxlibici').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 17:42:07", :created_at => "2013-09-20 17:42:07", :cycling_group_id => CyclingGroup.where(:slug => 'irapuato-en-bici').first.id, :user_id => User.where(:username => 'Irapuatoenbici').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-20 21:09:42", :created_at => "2013-09-20 21:09:42", :cycling_group_id => CyclingGroup.where(:slug => 'bici-10').first.id, :user_id => User.where(:username => 'josue_jonathan_m').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-21 22:16:46", :created_at => "2013-09-21 22:16:46", :cycling_group_id => CyclingGroup.where(:slug => 'quiron').first.id, :user_id => User.where(:username => 'ulisesdupeyron83').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-23 15:03:19", :created_at => "2013-09-23 15:03:19", :cycling_group_id => CyclingGroup.where(:slug => 'guanajuato-en-bici').first.id, :user_id => User.where(:username => 'saiduran7').first.id},
{:permissions => nil, :verified => nil, :updated_at => "2013-09-23 15:52:13", :created_at => "2013-09-23 15:52:13", :cycling_group_id => CyclingGroup.where(:slug => 'comando-b').first.id, :user_id => User.where(:username => 'jgmilan').first.id}]) 
